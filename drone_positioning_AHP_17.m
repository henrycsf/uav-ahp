...
for i = 1:1:N_UAV
    ...
    Points_Linear(:,:,i) = [Center(i,1) Center(i,2);
        ...
        Center(i,1)+Step(1) Center(i,2);
        Center(i,1)+Step(1) Center(i,2)+Step(2);
        Center(i,1)-(Step(1)/2) Center(i,2)+(Step(2)/2);
        Center(i,1)+(Step(1)/2) Center(i,2)-(Step(2)/2);
        Center(i,1)+(Step(1)/2) Center(i,2)+(Step(2)/2);
        Center(i,1)-(Step(1)/2) Center(i,2)-(Step(2)/2);
        Center(i,1)-(Step(1)/2) Center(i,2);
        Center(i,1)+(Step(1)/2) Center(i,2);
        Center(i,1) Center(i,2)+(Step(2)/2);
        Center(i,1) Center(i,2)-(Step(2)/2)
    ];
...
names = {'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9', 'P10', 'P11', 'P12', 'P13', 'P14', 'P15', 'P16', 'P17'};
